...
public final class SuratKeteranganSehat extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnCetakSuratSehat.setText("Cetak Surat Sehat RSPK");
       ...
       if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                Valid.MyReportqry("rptSuratKeteranganSehatRSPK.jasper","report","::[ Surat Keterangan Sehat ]::",
                              " select surat_keterangan_sehat.no_surat,(surat_keterangan_sehat.tanggalsurat)as tanggalsurat,surat_keterangan_sehat.berat,surat_keterangan_sehat.tinggi,surat_keterangan_sehat.tensi,surat_keterangan_sehat.suhu, "+
                              ...
                              " pasien.nm_pasien,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat,concat(pasien.tmp_lahir,', ',DATE_FORMAT(pasien.tgl_lahir,'%d %M %Y')) as tmp_lahir" +
    ...
    if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                Valid.MyReportqry("rptSuratKeteranganSehat2.jasper","report","::[ Surat Keterangan Sehat ]::",
                              ...
                              " surat_keterangan_sehat.butawarna,surat_keterangan_sehat.keperluan,surat_keterangan_sehat.kesimpulan,dokter.nm_dokter,pasien.jk,(pasien.tgl_lahir) as tgl_lahir,reg_periksa.kd_dokter, " +
