...
public final class SuratKeteranganCovid extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-07-2022" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-07-2022" }));
        ...
        TanggalAkhir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-07-2022" }));
        ...
        TanggalAwal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-07-2022" }));
        ...
        TidakSehat.setText("Positif & Ada Tanda Dan Gejala Tertular Covid-19");
        ...
        Sehat.setText("Negatif & Tidak Ada Tanda Dan Gejala Tertular Covid-19");
        ...
        if(tabMode.getRowCount()==0){
            ...
            param.put("logo",Sequel.cariGambar("select logo from setting")); 
              Valid.MyReportqry("rptDataSuratCovid.jasper","report","::[ Data Surat Keterangan Covid ]::",
                "select surat_keterangan_covid.no_surat,surat_keterangan_covid.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.no_ktp,pasien.umur,pasien.no_tlp, "+
        ...
        if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                Valid.MyReportqry("rptSuratKeteranganCovid.jasper","report","::[ Surat Keterangan Covid ]::",
                            "select surat_keterangan_covid.no_surat,surat_keterangan_covid.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.no_ktp,pasien.umur,pasien.no_tlp,spesialis.nm_sps, "+
